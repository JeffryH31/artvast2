  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative pt-20 sm:pt-24">
        <div className="bg-gradient-to-r from-[#DFE7F7] via-[#1B6EF3] to-[#1B6EF3] py-12 sm:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
              ...
              <div className="relative">
                ...
                {designer.verified && (
                  <div className="absolute -bottom-2 -right-2 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-[#1B6EF3] to-[#1755E0] rounded-full flex items-center justify-center shadow-lg border-2 border-white">
                ...
                <button 
                  ...
                  className={`px-6 sm:px-8 py-3 font-bold rounded-xl transition-all duration-300 shadow-lg cursor-pointer flex items-center justify-center space-x-2 ${
                    isFollowing 
                      ...
                      : 'bg-white text-[#1B6EF3] hover:bg-gray-100'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            {designer.featured_works.map((work) => (
              <div
                key={work.id}
                className="group relative aspect-square bg-gradient-to-br from-[#DFE7F7]/20 to-[#1B6EF3]/20 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-16">
        ...
        {productsLoading ? (
          <div className="text-center py-12">
            <div className="w-12 h-12 border-4 border-[#1B6EF3] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
            ...
            {filteredProducts.map((product) => (
              <Link
                ...
                <div className="relative h-48 sm:h-56 overflow-hidden">
                  ...
                  {product.featured && (
                    <div className="absolute top-3 left-3 px-2 py-1 bg-gradient-to-r from-[#1B6EF3] to-[#1755E0] text-white text-xs font-bold rounded-full">
                      FEATURED
                    </div>
                  )}
                ...
                <div className="p-4 sm:p-5">
                  <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white mb-1 group-hover:text-[#1B6EF3] transition-colors truncate">
                    {product.name}
                  </h3>
                  <div className="flex items-center justify-between">
                    <span className="px-2 py-0.5 bg-[#1B6EF3]/10 dark:bg-[#1B6EF3]/20 text-[#1B6EF3] text-xs font-medium rounded-full">
      ...
      {designer && (
        <MessageModal
          ...
          designerGradient={designer.avatar_gradient || 'from-[#DFE7F7] to-[#1B6EF3]'}
        />
      )}
    </div>
  );
