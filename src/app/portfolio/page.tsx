  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="pt-16 sm:pt-20">
        {/* Hero Section */}
        <div className="bg-gradient-to-br from-[#DFE7F7]/10 via-[#1B6EF3]/10 to-[#1B6EF3]/10 dark:from-[#DFE7F7]/20 dark:via-[#1B6EF3]/20 dark:to-[#1B6EF3]/20 py-10 sm:py-12 lg:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">
              {t.portfolioPage.showcaseYour}{" "}
              <span className="bg-gradient-to-r from-[#1B6EF3] via-[#1B6EF3] to-[#1B6EF3] bg-clip-text text-transparent">
        ...
        <div className="bg-gradient-to-r from-[#1B6EF3] to-[#1755E0] py-10 sm:py-12 lg:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <a href="/become-designer" className="bg-white text-[#1B6EF3] px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-sm sm:text-base hover:bg-gray-50 transform hover:scale-105 transition-all duration-300 shadow-lg">
