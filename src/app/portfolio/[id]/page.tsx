      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="pt-20">
          <div className="max-w-6xl mx-auto px-4 py-16 text-center">
            ...
            <Link
              href="/portfolio"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#1B6EF3] to-[#1B6EF3] text-white font-semibold rounded-xl hover:shadow-lg transition-all duration-300"
            >
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <main className="pt-16 sm:pt-20">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm mb-6 sm:mb-8">
            <div className="relative">
              {portfolio.image_url?.startsWith("http") ? (
                ...
                <div className="aspect-video flex items-center justify-center bg-gradient-to-br from-[#DFE7F7]/20 to-[#1B6EF3]/20">
                  <svg
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="lg:col-span-2">
                ...
                >
                  ...
                  {portfolio.designer?.avatar_url ? (
                    <img
                      ...
                      className="w-12 h-12 sm:w-14 sm:h-14 rounded-full object-cover ring-2 ring-transparent group-hover:ring-[#1B6EF3] transition-all duration-300"
                    />
                  ) : (
                    <div
                      className="w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center text-white text-lg font-bold ring-2 ring-transparent group-hover:ring-[#1B6EF3] transition-all duration-300"
                      style={{
                        background: portfolio.designer?.avatar_gradient || "linear-gradient(135deg, #DFE7F7, #1B6EF3)",
                      }}
                    >
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white group-hover:text-[#1B6EF3] transition-colors">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                {portfolio.featured && (
                  <span className="px-4 py-1.5 bg-gradient-to-r from-[#1B6EF3] to-[#1B6EF3] text-white rounded-full text-sm font-medium">
                    Featured
                  </span>
                )}
              </div>
              ...
              <div className="flex items-center justify-between mb-6 sm:mb-8">
                ...
                {portfolio.designer && (
                  <Link
                    ...
                    className="text-[#1B6EF3] hover:text-[#1B6EF3] font-medium text-sm transition-colors"
                  >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
                {moreFromDesigner.map((item) => (
                  ...
                  >
                    ...
                    <h4 className="mt-2 text-sm font-medium text-gray-900 dark:text-white truncate group-hover:text-[#1B6EF3] transition-colors">
                      {item.title}
                    </h4>
                  </Link>
                ))}
        ...
        {/* Footer CTA */}
        <section className="bg-gradient-to-r from-[#1B6EF3] to-[#1B6EF3] py-12 sm:py-16">
