  ...
  return (
    <div className="min-h-screen relative overflow-hidden transition-colors duration-300">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div
          className="absolute top-1/3 left-1/2 w-[450px] h-[450px] bg-gradient-to-br from-[#234CF9]/15 to-[#234CF9]/15 rounded-full blur-3xl opacity-50 animate-float"
      ...
      <div className="relative pt-16 sm:pt-20">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-[#DFE7F7] via-[#234CF9] to-[#234CF9] py-10 sm:py-12 lg:py-16 shadow-2xl">
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2.5 sm:py-3 border border-gray-300 dark:border-gray-600 rounded-xl leading-5 bg-white dark:bg-gray-800 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-[#234CF9] focus:border-[#234CF9] text-sm sm:text-base transition-colors duration-300"
                />
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {paginatedProducts.map((product, index) => (
              <Link
                ...
                key={product.id}
                className="group bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden shadow-lg hover:shadow-[0_8px_32px_rgba(35,76,249,0.2)] transform hover:scale-105 hover:-translate-y-2 transition-all duration-500 border border-white/10 hover:border-[#234CF9]/30"
                ...
                <div className="p-4 sm:p-5 lg:p-6">
                  <div className="flex justify-between items-start mb-2 sm:mb-3">
                    <div className="flex-1 min-w-0 pr-2">
                      <h3 className="text-sm sm:text-base lg:text-lg font-bold text-gray-900 dark:text-white mb-0.5 sm:mb-1 group-hover:text-[#234CF9] transition-colors duration-200 truncate">
                        {product.name}
                      </h3>
                  ...
                  <div className="mb-3 sm:mb-4">
                    <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-[#DFE7F7]/10 to-[#234CF9]/10 text-[#234CF9] text-xs sm:text-sm font-medium rounded-full border border-[#234CF9]/20">
                  ...
                  {designerProfile && product.designer_id === designerProfile.id ? (
                    <div className="flex items-center justify-center space-x-2 px-3 py-2 bg-gradient-to-r from-[#234CF9]/10 to-[#234CF9]/10 text-[#234CF9] text-xs sm:text-sm font-medium rounded-lg border border-[#234CF9]/20">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-[#234CF9] to-[#234CF9] text-white px-3 sm:px-4 py-2 rounded-lg sm:rounded-xl font-medium text-xs sm:text-sm hover:from-[#234CF9] hover:to-[#234CF9] transition-all duration-300 transform hover:scale-105 disabled:opacity-50 cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className={`px-3 sm:px-4 py-2 border rounded-lg sm:rounded-xl transition-colors duration-200 cursor-pointer ${
                        isSaved(product.id)
                          ? 'border-[#234CF9] bg-[#234CF9]/10 text-[#234CF9]'
                          : 'border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-[#234CF9] hover:bg-[#234CF9]/5'
                      }`}
                    >
                      <svg
        ...
        {/* Recommended Section */}
        <div className="bg-gradient-to-br from-[#DFE7F7]/10 via-[#234CF9]/10 to-[#234CF9]/10 dark:from-[#DFE7F7]/5 dark:via-[#234CF9]/5 dark:to-[#234CF9]/5 py-10 sm:py-12 lg:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              {products.slice(0, 3).map((product) => (
                ...
                >
                  <div className="h-40 sm:h-44 lg:h-48 overflow-hidden bg-gradient-to-br from-[#DFE7F7]/20 to-[#234CF9]/20">
                    {product.image_url && product.image_url.startsWith('http') ? (
                      <img 
                        src={product.image_url} 
                        alt={product.name}
                  ...
                  <div className="p-3 sm:p-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-base sm:text-lg font-bold bg-gradient-to-r from-[#234CF9] to-[#234CF9] bg-clip-text text-transparent">
                        {formatPrice(product.price)}
                      </span>
        ...
        <div className="bg-gradient-to-r from-[#234CF9] to-[#1C277B] py-10 sm:py-12 lg:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <button className="bg-white text-[#234CF9] px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold hover:bg-gray-50 transform hover:scale-105 transition-all duration-300 shadow-lg text-sm sm:text-base cursor-pointer">
                Start Selling
              </button>
