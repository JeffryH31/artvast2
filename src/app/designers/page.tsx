            ...
            <div className="flex flex-col gap-4">
                  ...
                  <button
                    ...
                    className={`flex-shrink-0 px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg sm:rounded-xl font-medium sm:font-semibold text-sm sm:text-base transition-all duration-300 cursor-pointer ${
                      selectedCategory === category.value
                        ? "bg-gradient-to-r from-[#1B6EF3] to-[#1B6EF3] text-white shadow-lg"
              ...
              <div className="flex items-center justify-between sm:justify-end space-x-2 sm:space-x-3">
                ...
                <select
                  ...
                  className="flex-1 sm:flex-none px-3 sm:px-4 py-2 sm:py-2.5 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg sm:rounded-xl text-gray-700 dark:text-gray-300 font-medium text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#1B6EF3] focus:border-transparent transition-all duration-200"
                >
            ...
            {paginatedDesigners.map((designer) => (
              ...
              >
                ...
                <div className="relative p-4 sm:p-5 lg:p-6 bg-transparent">
                  ...
                  <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-base sm:text-lg lg:text-xl font-bold text-gray-900 dark:text-white group-hover:text-[#1B6EF3] transition-colors duration-200 truncate">
                        {designer.name}
                      </h3>
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-3 sm:mb-4">
                    {designer.specialties?.map((specialty) => (
                      <span
                        key={specialty}
                        className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-[#DFE7F7]/10 to-[#1B6EF3]/10 text-[#1B6EF3] text-[10px] sm:text-xs font-semibold rounded-full border border-[#1B6EF3]/20"
                      >
                        {specialty}
                      </span>
                    ))}
                ...
                <div className="p-3 sm:p-4 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700">
                  <button className="w-full py-2.5 sm:py-3 bg-gradient-to-r from-[#1B6EF3] to-[#1B6EF3] text-white font-bold text-sm sm:text-base rounded-lg sm:rounded-xl hover:shadow-lg transition-all duration-300 cursor-pointer">
                    View Profile
                  </button>
                </div>
              </Link>
