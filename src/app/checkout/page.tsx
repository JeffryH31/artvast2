      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 pt-24 pb-16 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{t.checkout.title}</h1>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-300">
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t.checkoutPage.contactInformation}</h2>
                ...
                {/* Payment Method */}
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-300">
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t.checkout.paymentMethod}</h2>
                  <div className="space-y-3">
                    {[
                      { id: 'card', label: t.checkoutPage.creditDebitCard, icon: '💳' },
                      { id: 'paypal', label: t.checkoutPage.paypal, icon: '🅿️' },
                      { id: 'crypto', label: t.checkoutPage.cryptocurrency, icon: '₿' },
                    ].map((method) => (
                      <label
                        key={method.id}
                ...
                {/* Order Notes */}
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-300">
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t.checkoutPage.orderNotesOptional}</h2>
                  <textarea
                    rows={3}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm sticky top-24 transition-colors duration-300">
                    ...
                    {items.map((item) => (
                      <div key={item.id} className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-gray-500 dark:text-gray-400 text-xs">{t.checkoutPage.qty}: {item.quantity}</p>
                        </div>
                  ...
                  >
                    {processing ? (
                      ...
                      <>
                        ...
                        {t.checkoutPage.completePurchase}
                      </>
                    )}
                  </button>
                  ...
                  <div className="mt-6 flex items-center justify-center gap-4 text-gray-500 dark:text-gray-400 text-xs">
                    <span className="flex items-center gap-1">
                      ...
                      {t.checkoutPage.sslSecured}
                    </span>
                    <span className="flex items-center gap-1">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      {t.checkoutPage.verified}
                    </span>
                  </div>
                </div>
              </div>
