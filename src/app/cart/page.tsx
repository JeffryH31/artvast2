        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="animate-pulse bg-white/5 rounded-xl h-32"></div>
              ))}
            </div>
          ) : items.length > 0 ? (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-4">
                {items.map((item) => (
                  ...
                  >
                    {/* Product Image */}
                    <div className="w-full sm:w-24 h-32 sm:h-24 bg-white/10 rounded-lg flex items-center justify-center text-4xl shrink-0">
                      ...
                      <div className="flex items-center justify-between mt-4">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="w-8 h-8 rounded-lg bg-white/10 text-white flex items-center justify-center hover:bg-white/20 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                          >
                            -
                          </button>
              ...
              <div className="lg:col-span-1">
                <div className="bg-white/5 rounded-xl p-6 border border-white/10 sticky top-24">
                  ...
                  <Link
                    href="/marketplace"
                    className="block w-full py-3 px-4 mt-3 bg-white/5 hover:bg-white/10 text-white font-medium rounded-lg text-center transition-colors"
                  >
                    Continue Shopping
                  </Link>
