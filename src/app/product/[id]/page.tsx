...
const ProductDetailPage: React.FC<ProductDetailPageProps> = ({ params }) => {
      ...
      <div className="min-h-screen relative overflow-hidden transition-colors duration-300">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            <div className="w-16 h-16 border-4 border-[#1B6EF3] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
      ...
      <div className="min-h-screen relative overflow-hidden transition-colors duration-300">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <Link
              href="/marketplace"
              className="px-6 py-2 bg-gradient-to-r from-[#1B6EF3] to-[#1B6EF3] text-white rounded-xl font-medium"
            >
  ...
  return (
    <div className="min-h-screen relative overflow-hidden transition-colors duration-300">
      ...
      <div className="fixed inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800"></div>
        <div className="absolute -top-20 sm:-top-40 -right-20 sm:-right-40 w-[250px] sm:w-[400px] lg:w-[500px] h-[250px] sm:h-[400px] lg:h-[500px] bg-gradient-to-br from-[#DFE7F7]/20 to-[#1B6EF3]/20 rounded-full blur-3xl opacity-60 animate-pulse"></div>
        <div className="absolute top-1/4 -left-20 sm:-left-40 w-[300px] sm:w-[500px] lg:w-[600px] h-[300px] sm:h-[500px] lg:h-[600px] bg-gradient-to-br from-[#1B6EF3]/15 to-[#1755E0]/15 rounded-full blur-3xl opacity-50 animate-float"></div>
        <div className="absolute bottom-10 sm:bottom-20 right-1/4 w-[200px] sm:w-[300px] lg:w-[400px] h-[200px] sm:h-[300px] lg:h-[400px] bg-gradient-to-br from-[#1B6EF3]/15 to-[#1B6EF3]/15 rounded-full blur-3xl opacity-60 animate-float" style={{ animationDelay: '3s', animationDuration: '12s' }}></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 pt-20 sm:pt-24">
        <div className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm overflow-x-auto whitespace-nowrap">
          <Link href="/" className="text-gray-600 dark:text-gray-400 hover:text-[#1B6EF3] transition-colors flex-shrink-0">
            {t.breadcrumb.home}
          </Link>
          <span className="text-gray-400 dark:text-gray-500">/</span>
          <Link href="/marketplace" className="text-gray-600 dark:text-gray-400 hover:text-[#1B6EF3] transition-colors flex-shrink-0">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="space-y-3 sm:space-y-4">
            {/* Main Image */}
            <div className="relative aspect-square rounded-2xl sm:rounded-3xl overflow-hidden bg-white/5 shadow-xl sm:shadow-2xl border border-white/10">
              {hasImages ? (
                <img 
                ...
                <div className="w-full h-full bg-gradient-to-br from-[#DFE7F7]/20 to-[#1B6EF3]/20 flex items-center justify-center">
              ...
              {product.featured && (
                <div className="absolute top-3 right-3 sm:top-6 sm:right-6 px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-[#1B6EF3] to-[#1755E0] text-white text-xs sm:text-sm font-bold rounded-full shadow-lg">
                  Featured
                </div>
              )}
              {product.bestseller && (
                <div className="absolute top-3 left-3 sm:top-6 sm:left-6 px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-[#1B6EF3] to-[#1B6EF3] text-white text-xs sm:text-sm font-bold rounded-full shadow-lg">
                  Bestseller
                </div>
              )}
            </div>
                ...
                {productImages.map((img, index) => (
                  <button
                    ...
                    className={`aspect-square rounded-lg sm:rounded-xl overflow-hidden transition-all duration-300 cursor-pointer ${
                      selectedImage === index
                        ? "ring-2 sm:ring-4 ring-[#1B6EF3] scale-105"
                        : "ring-1 sm:ring-2 ring-gray-200 dark:ring-gray-700 hover:ring-[#DFE7F7]"
                    }`}
                  >
                    <img 
                      src={img} 
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-wrap items-baseline gap-2 sm:gap-3">
              <span className="text-3xl sm:text-4xl lg:text-5xl font-black bg-gradient-to-r from-[#1B6EF3] to-[#1755E0] bg-clip-text text-transparent">
              ...
              {product.original_price && (
                <>
                  ...
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gradient-to-r from-[#1B6EF3] to-[#1B6EF3] text-white text-xs sm:text-sm font-bold rounded-full">
            ...
            {/* Category */}
            <div>
              <span className="px-3 py-1 bg-gradient-to-r from-[#DFE7F7]/10 to-[#1B6EF3]/10 text-[#1B6EF3] text-sm font-medium rounded-full border border-[#1B6EF3]/20">
            ...
            {product.features && product.features.length > 0 && (
              <div className="bg-gradient-to-br from-[#DFE7F7]/10 to-[#1B6EF3]/10 dark:from-[#DFE7F7]/20 dark:to-[#1B6EF3]/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-[#DFE7F7]/20 dark:border-[#DFE7F7]/30">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                  {product.features.map((feature, index) => (
                    <div key={index} className="flex items-center space-x-2">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#1B6EF3] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="flex items-center space-x-2 text-gray-700 dark:text-gray-300">
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#1B6EF3] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span className="text-sm sm:text-base font-semibold">Delivery:</span>
              <span className="text-sm sm:text-base text-[#1B6EF3] font-bold">{product.delivery_time}</span>
            </div>

            {/* Action Buttons - Show for users only, Your Product for own products */}
            {isProductOwner ? (
              <div className="bg-gradient-to-br from-[#1B6EF3]/10 to-[#1B6EF3]/10 dark:from-[#1B6EF3]/20 dark:to-[#1B6EF3]/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-[#1B6EF3]/20 dark:border-[#1B6EF3]/30">
                <div className="flex items-center space-x-3 text-[#1B6EF3]">
                ...
                <Link 
                  ...
                  className="inline-flex items-center space-x-2 mt-3 px-4 py-2 bg-gradient-to-r from-[#1B6EF3] to-[#1B6EF3] text-white font-medium text-sm rounded-lg hover:shadow-lg transition-all duration-300"
                >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-4">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-[#DFE7F7] to-[#1B6EF3] opacity-100 group-hover:opacity-90 transition-opacity"></div>
              ...
              <button 
                ...
                className="flex-1 relative group overflow-hidden rounded-xl sm:rounded-2xl disabled:opacity-50 cursor-pointer"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-[#1B6EF3] to-[#1755E0]"></div>
            ...
            <button 
              ...
              className={`w-full flex items-center justify-center space-x-2 px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3 border-2 font-semibold rounded-xl sm:rounded-2xl transition-all duration-300 text-sm sm:text-base cursor-pointer ${
                isSaved(id)
                  ...
                  : 'border-[#1B6EF3] text-[#1B6EF3] hover:bg-[#1B6EF3] hover:text-white'
              }`}
            >
        ...
        {/* Designer Section */}
        {product.designer && (
          <div className="mt-10 sm:mt-16 bg-white/5 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-xl sm:shadow-2xl border border-white/10">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">Designer</h2>
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              <div className="relative flex-shrink-0">
                <div className={`w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br ${product.designer.avatar_gradient || 'from-[#DFE7F7] to-[#1B6EF3]'} rounded-full flex items-center justify-center text-white text-xl sm:text-2xl font-bold shadow-xl`}>
                  {product.designer.avatar_initials}
                </div>
                {product.designer.verified && (
                  <div className="absolute -bottom-1 -right-1 w-6 h-6 sm:w-7 sm:h-7 bg-gradient-to-r from-[#1B6EF3] to-[#1755E0] rounded-full flex items-center justify-center shadow-lg">
              ...
              <Link
                ...
                className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-[#1B6EF3] to-[#1B6EF3] text-white font-bold text-sm sm:text-base rounded-lg sm:rounded-xl hover:shadow-xl transform hover:scale-105 transition-all duration-300 text-center"
              >
                View Profile
              </Link>
            </div>
