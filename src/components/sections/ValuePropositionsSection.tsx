    ...
    <div className="seamless-section text-white">
      <div className="pt-20 pb-24 lg:pb-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative -mt-20 mb-24 z-30">
            <div
              className="animate-float"
              style={{ transform: "translateX(-50%)", animationDuration: "5s" }}
            >
              <div className="bg-white/10 backdrop-blur-md z-50 rounded-xl px-8 py-4 border border-white/20 shadow-xl hover:bg-white/15 transition-all duration-300 hover:scale-105 w-max mx-auto">
          ...
          <div className="text-center mb-24">
            ...
            <p
              className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-8 animate-fade-in-up"
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ...
              <Magnetic key={index} intensity={0.1}>
                <div
                  className={`group bg-white/95 backdrop-blur-sm rounded-3xl p-10 shadow-2xl hover:${service.glowColor} hover:shadow-3xl transform hover:scale-105 hover:-translate-y-3 transition-all duration-500 border border-white/10 relative overflow-hidden`}
                >
                  ...
                  <div className="text-center relative z-10">
                    <div className="relative mb-8">
                      <div
                        className={`w-20 h-20 bg-gradient-to-r ${service.badgeColor} rounded-2xl flex items-center justify-center mx-auto group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-xl relative overflow-hidden`}
                      >
                      ...
                      <div
                        className={`absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-r ${service.badgeColor} rounded-full flex items-center justify-center text-white text-sm font-bold shadow-lg`}
                      >
                        {service.badge}
                      </div>
                    </div>
