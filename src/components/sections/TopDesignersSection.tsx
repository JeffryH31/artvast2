...
const TopDesignersSection: React.FC = () => {
  ...
  const stats = [
    { value: "500+", label: "Verified Designers", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z", color: "text-[#234CF9]", bg: "bg-[#234CF9]/10" },
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 xl:py-32 bg-[#F4F7FF] dark:bg-[#050B1A] relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#234CF9]/6 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#1C277B]/5 rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 lg:gap-16 items-center">
          ...
          <div className="space-y-5 sm:space-y-6">
            <div className="animate-fade-in-up">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#234CF9]/10 border border-[#234CF9]/25 text-[#234CF9] text-xs sm:text-sm font-semibold mb-4">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 dark:text-white leading-tight">
                ...
                <span className="block bg-gradient-to-r from-[#234CF9] via-[#1C277B] to-[#234CF9] bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient-x">
            ...
            {/* Card 1 */}
            <div className="bg-white dark:bg-white/5 rounded-2xl p-5 sm:p-6 group border border-gray-100 dark:border-white/10 hover:border-[#234CF9]/30 hover:shadow-[0_8px_32px_rgba(35,76,249,0.10)] transition-all duration-300 shadow-sm backdrop-blur-sm">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-11 h-11 sm:w-12 sm:h-12 btn-primary rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-[0_0_16px_rgba(35,76,249,0.3)]">
            ...
            <div className="bg-white dark:bg-white/5 rounded-2xl p-5 sm:p-6 group border border-gray-100 dark:border-white/10 hover:border-[#234CF9]/30 hover:shadow-[0_8px_32px_rgba(35,76,249,0.10)] transition-all duration-300 shadow-sm backdrop-blur-sm">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-11 h-11 sm:w-12 sm:h-12 bg-[#234CF9]/10 dark:bg-[#1C277B]/60 border border-[#234CF9]/20 dark:border-[#234CF9]/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#234CF9] dark:text-[#DFE7F7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="order-first lg:order-last flex items-center justify-center">
            <div className="relative w-full max-w-md">
              ...
              {/* Glow effect */}
              <div className="absolute inset-0 bg-[#234CF9]/10 rounded-3xl blur-[60px] scale-90 pointer-events-none" />

              {/* Main dashboard card */}
              <div className="relative bg-white dark:bg-[#0D1B3E] rounded-3xl p-6 sm:p-7 border border-gray-100 dark:border-[#234CF9]/20 shadow-[0_20px_60px_rgba(35,76,249,0.12)] dark:shadow-[0_0_60px_rgba(35,76,249,0.15)]">
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  {stats.map((stat) => (
                    <div
                      key={stat.label}
                      className="rounded-2xl p-4 border border-gray-100 dark:border-white/8 bg-gray-50 dark:bg-white/4 hover:border-[#234CF9]/25 transition-colors duration-300"
                    >
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-2">
                    {categories.map((cat) => (
                      <div key={cat.label} className="flex items-center justify-between py-2 px-3 rounded-xl bg-gray-50 dark:bg-white/4 hover:bg-[#234CF9]/6 dark:hover:bg-white/8 border border-transparent hover:border-[#234CF9]/20 transition-all duration-200 cursor-pointer group/cat">
                        <span className="text-sm font-medium text-gray-700 dark:text-white/75 group-hover/cat:text-[#234CF9] transition-colors">{cat.label}</span>
                        <div className="flex items-center gap-2">
                          <span className="text-xs text-gray-400 dark:text-white/35">{cat.count} designers</span>
                          <svg className="w-3.5 h-3.5 text-gray-300 dark:text-white/20 group-hover/cat:text-[#234CF9] group-hover/cat:translate-x-0.5 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="absolute -top-4 -right-4 sm:-top-5 sm:-right-5 bg-white dark:bg-[#234CF9] border border-gray-100 dark:border-transparent rounded-2xl px-3 py-2 shadow-[0_4px_20px_rgba(35,76,249,0.20)] dark:shadow-[0_0_20px_rgba(35,76,249,0.5)] animate-bounce-slow flex items-center gap-1.5">
                <svg className="w-4 h-4 text-[#234CF9] dark:text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span className="text-[#234CF9] dark:text-white text-xs font-bold">Top Rated</span>
              </div>

              {/* Floating badge bottom-left */}
              <div className="absolute -bottom-4 -left-4 sm:-bottom-5 sm:-left-5 bg-white dark:bg-[#0D1B3E] rounded-2xl px-3 py-2.5 border border-gray-100 dark:border-[#234CF9]/25 shadow-[0_4px_20px_rgba(35,76,249,0.12)] animate-float flex items-center gap-2">
                <div className="flex -space-x-2">
                  {["#234CF9", "#10B981", "#F59E0B"].map((c, i) => (
