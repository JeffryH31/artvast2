...
const FeaturedDesignersRow: React.FC = () => {
  ...
  if (loading) {
    return (
      <section className="bg-white/3 py-8 sm:py-12 transition-colors duration-300">
  ...
  return (
    <section className="bg-white dark:bg-[#050B1A]/80 backdrop-blur-sm py-8 sm:py-12 border-y border-gray-100 dark:border-white/5 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
          ...
          {topDesigners.map((designer) => (
            ...
            >
              <div className="bg-white dark:bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 text-center shadow-sm hover:shadow-[0_8px_24px_rgba(27,110,243,0.18)] border border-gray-100 dark:border-white/10 hover:border-[#1B6EF3]/40 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1">
                ...
                {/* Stats */}
                <div className="flex items-center justify-center gap-3 text-xs text-gray-400 dark:text-white/40">
