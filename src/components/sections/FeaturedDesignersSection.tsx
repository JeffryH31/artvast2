...
const FeaturedDesignersSection: React.FC = () => {
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-50 via-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">Loading amazing designers...</p>
          </div>
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
      ...
      <div className="absolute top-20 right-20 w-80 h-80 bg-[#5D6BC6]/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-[#BD9587]/10 rounded-full blur-3xl"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {featuredDesigners.map((designer) => (
            <Link
              ...
              className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-500 border border-gray-100"
            >
              {/* Avatar */}
              ...
              <div className="text-center">
                <h3 className="text-lg font-bold text-gray-900 mb-1 group-hover:text-[#5D6BC6] transition-colors">
                  {designer.name}
                </h3>
                <p className="text-sm text-gray-600 mb-3">{designer.username}</p>
                ...
                <div className="flex items-center justify-center gap-1 mb-3">
                  ...
                  <span className="text-xs text-gray-500">({designer.projects_count} projects)</span>
                </div>
