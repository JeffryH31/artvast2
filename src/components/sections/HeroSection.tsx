...
const HeroSection: React.FC = () => {
  ...
  return (
    <div className="text-white dark:text-gray-100 relative overflow-hidden min-h-screen pt-16 sm:pt-20">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#2563EB]/25 rounded-full blur-[120px] animate-gentle-pulse pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-[#1B6EF3]/30 rounded-full blur-[100px] animate-gentle-pulse delay-700 pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#2563EB]/15 rounded-full blur-[150px] pointer-events-none" />
      {/* Konten Utama Hero */}
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-20 flex items-center justify-center min-h-[85vh] sm:min-h-[90vh] z-20">
        <div className="max-w-3xl w-full text-center">
          ...
          <div className="animate-fade-in-up mb-4 sm:mb-6 flex justify-center">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#1B6EF3]/20 border border-[#1B6EF3]/40 text-[#DFE7F7] text-xs sm:text-sm font-medium backdrop-blur-sm animate-glow-pulse">
          ...
          <h1
            ...
            <span className="block bg-gradient-to-r from-[#1B6EF3] via-[#DFE7F7] to-[#1B6EF3] bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient-x">{t.hero.title.split(' ').slice(-2).join(' ')}</span>
          </h1>
            ...
            <form onSubmit={handleSearch} className="relative max-w-2xl mx-auto">
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full pl-12 sm:pl-14 pr-28 sm:pr-36 py-4 sm:py-5 rounded-full bg-white/95 dark:bg-gray-800/95 backdrop-blur-md text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 text-sm sm:text-base shadow-2xl border border-white/20 dark:border-gray-700/50 focus:outline-none focus:ring-2 focus:ring-[#1B6EF3] focus:border-transparent transition-all duration-300"
                />
                <button
                  type="submit"
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
              ...
              {trendingSearches.map((term, i) => (
                <button
                  ...
                  className="px-3 sm:px-4 py-1.5 bg-[#1B6EF3]/15 hover:bg-[#1B6EF3]/30 backdrop-blur-sm rounded-full text-xs sm:text-sm text-[#DFE7F7]/80 hover:text-white border border-[#1B6EF3]/25 hover:border-[#1B6EF3]/60 transition-all duration-300 cursor-pointer hover:scale-105 hover:shadow-[0_0_12px_rgba(27,110,243,0.4)]"
