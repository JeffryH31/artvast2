...
const HeroSection: React.FC = () => {
  return (
    <div className="text-white relative overflow-hidden min-h-screen pt-20">
      {/* Konten Utama Hero */}
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 flex items-center min-h-[90vh] z-20">
        <div className="max-w-2xl">
          ...
          <h1
            className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fade-in-up"
            style={{ animationDelay: "0.2s" }}
          >
            Empowering Designers, Building a Creative Community
          </h1>
          <p
            className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl leading-relaxed animate-fade-in-up"
          ...
          <div
            className="grid grid-cols-3 gap-8 pt-8 border-t border-white/20 animate-fade-in-up"
