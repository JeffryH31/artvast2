...
const Badge: React.FC<BadgeProps> = ({
  ...
  const baseClasses = 'inline-block backdrop-blur-sm rounded-full font-medium border';
  
  const variantClasses = {
    default: 'bg-white/10 text-white/90 border-white/20',
    gradient: 'bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 border-blue-200',
